...
{
    /// <inheritdoc />
    public partial class SeedingDataForDifficultiesandReginos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("860560d9-28f9-4030-9dda-939259e6d2b7"), "Hard" },
                    { new Guid("90b810d4-9dde-4d70-b591-d62cafb2b23c"), "Medium" },
                    { new Guid("d38e0a74-78a1-40f4-a92c-9eee73ca4407"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("860560d9-28f9-4030-9dda-939259e6d2b7"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("90b810d4-9dde-4d70-b591-d62cafb2b23c"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("d38e0a74-78a1-40f4-a92c-9eee73ca4407"));
